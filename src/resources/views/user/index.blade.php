            ...
            <tbody class="text-gray-700 divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="p-4 flex justify-center space-x-2">
                        ...
                        <form action="{{ route('user.destroy', $user->id_petugas) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                            @csrf @method('DELETE')
        ...
        <div class="bg-white rounded-2xl w-full max-w-md p-6 shadow-xl">
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_petugas" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#4A6CF7] block w-full p-2.5">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-6">
                    ...
                    <select name="level" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#4A6CF7] block w-full p-2.5">
    ...
    <div id="modal-edit" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl w-full max-w-md p-6 shadow-xl">
            ...
            <form id="form-edit" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
                    <input type="text" id="edit-nama_petugas" name="nama_petugas" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#4A6CF7] block w-full p-2.5">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#4A6CF7] block w-full p-2.5">
                </div>
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Role (Hak Akses)</label>
                    <select id="edit-level" name="level" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#4A6CF7] block w-full p-2.5">
                        <option value="petugas">Petugas</option>
                        <option value="admin">Admin</option>
                    </select>
                </div>
